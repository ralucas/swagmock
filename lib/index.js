...
function SwagMock(api, { validated, testTemplates } = {}) {
...
SwagMock.prototype.responses = function(options = {}, callback) {
    ...
    options.testTemplates = this.testTemplates;
...
const mockOperation = (resolved, opsObj, mock, options) => {
    ...
    if (options.mockRequest) {
        ...
        let mr = mockRequest(resolved, mock.parameters || mockParameters(resolved, opsObj, options), opsObj, options);
        let successResponse = opsObj.responses && Object.keys(opsObj.responses).filter(r => Number(r) >= 200)[0];

        if (options.testTemplates && successResponse) {
            mock[successResponse] = mr;
            console.log(mr);
        } else {
            mock.request = mr;
        }
 ...
 */
const mockRequest = (resolved, parameters, opsObj, options) => {
    let mock = {};
    let queryObj = {};
    let headerObj = {};
    let formObj = {};
    ...
    if (parameters) {
        ...
        if (parameters.path && parameters.path.length > 0) {
            parameters.path.forEach(function (pathParam) {
                if (pathParam && pathParam.name) {
                    if (options.testTemplates) {
                      let pathnameObj = {};
                      pathnameObj[pathParam.name] = pathParam.value;
                      mockDataObj = Object.assign(mockDataObj, pathnameObj);
                    }
        ...
        if (parameters.query && parameters.query.length > 0) {
            ...
            if (options.testTemplates) {
                mockDataObj = Object.assign(mockDataObj, queryObj);
                //mock.push(queryObj);
            } else {
        ...
        if (parameters.body && parameters.body.length > 0) {
            if (options.testTemplates) {
                mockDataObj = Object.assign(mockDataObj, { body: parameters.body[0].value });
                //mock.push({ body: parameters.body[0].value });
            } else {
        ...
        if (parameters.header && parameters.header.length > 0) {
            ...
            if (options.testTemplates) {
                mockDataObj = Object.assign(mockDataObj, headerObj);
                //mock.push(headerObj);
            } else {
        ...
        if (parameters.formData && parameters.formData.length > 0) {
            ...
            if (options.testTemplates) {
                mockDataObj = Object.assign(mockDataObj, formObj);
                //mock.push(formObj);
            } else {
    ...
    if (options.testTemplates) {
      mockDataObj.description = `mocked test [${pathname}]`;
      mock.push(mockDataObj);
      return mock;
    }
    return mock;
};
